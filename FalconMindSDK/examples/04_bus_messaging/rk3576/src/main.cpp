/**
 * FalconMindSDK 示例04：Bus消息总线（${platform^^}平台版本）
 */
...
int main() {
    std::cout << "================================================================================" << std::endl;
    std::cout << "                FalconMindSDK 示例04: Bus消息总线 (${platform^^})" << std::endl;
    std::cout << "================================================================================" << std::endl;
    std::cout << std::endl;
    ...
    bus->post(BusMessage{"detection", "目标检测结果: 车辆"});
    bus->post(BusMessage{"telemetry", "高度: 100m"});
    std::cout << std::endl;
