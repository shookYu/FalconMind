#!/bin/bash
# FalconMindSDK 示例02 - RK3588平台交叉编译脚本
#
# 功能:
# - 交叉编译RK3588版本
...
echo "================================================================================"
echo "              FalconMindSDK 示例02: NodeFactory节点工厂 (RK3588交叉编译)"
echo "================================================================================"
echo ""
...
echo ""
echo "[5] 生成可执行文件"
if [ -f "./02_node_factory_rk3588" ]; then
    echo "可执行文件: $BUILD_DIR/02_node_factory_rk3588"
    file ./02_node_factory_rk3588
    echo ""
    echo "================================================================================"
    echo "                    RK3588交叉编译完成"
    echo "================================================================================"
