#!/bin/bash
# FalconMindSDK 示例01 - RK3588平台交叉编译脚本
#
# 功能:
# - 交叉编译RK3588版本
# - 编译产物输出到rk3588/build目录
...
# - 编解码: 8K@30fps H.265, 8K@60fps VP9
#
...
PLATFORM_DIR="$EXAMPLE_DIR/rk3588"
BUILD_DIR="$PLATFORM_DIR/build"

echo "================================================================================"
echo "              FalconMindSDK 示例01: Pipeline基础流程 (RK3588交叉编译)"
echo "================================================================================"
echo ""
...
echo ""
echo "[5] 生成可执行文件"
if [ -f "./01_pipeline_basic_rk3588" ]; then
    echo "可执行文件: $BUILD_DIR/01_pipeline_basic_rk3588"
    file ./01_pipeline_basic_rk3588
    echo ""
    echo "================================================================================"
    echo "                    RK3588交叉编译完成"
    echo "================================================================================"
    echo "[提示] 请将可执行文件传输到RK3588设备上运行"
else
    echo "[错误] 编译产物不存在"
    exit 1
fi
