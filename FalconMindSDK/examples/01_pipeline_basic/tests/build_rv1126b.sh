#!/bin/bash
# FalconMindSDK 示例01 - RV1126B平台交叉编译脚本
#
# 功能:
# - 交叉编译RV1126B版本
...
# - 编解码: 4K@45fps H.265编码, 4K@30fps解码
#
...
echo "================================================================================"
echo "              FalconMindSDK 示例01: Pipeline基础流程 (RV1126B交叉编译)"
echo "================================================================================"
echo ""
...
SDK_LIB="$SDK_DIR/build_arm64/libfalconmind_sdk.a"
if [ ! -f "$SDK_LIB" ]; then
...
echo ""
echo "[5] 生成可执行文件"
if [ -f "./01_pipeline_basic_rv1126b" ]; then
    echo "可执行文件: $BUILD_DIR/01_pipeline_basic_rv1126b"
    file ./01_pipeline_basic_rv1126b
    echo ""
    echo "================================================================================"
    echo "                    RV1126B交叉编译完成"
    echo "================================================================================"
