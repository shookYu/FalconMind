...
echo "================================================================================"
echo "              FalconMindSDK 示例01: Pipeline基础流程 (全平台构建)"
echo "================================================================================"
echo ""
...
echo ""
echo "生成的可执行文件:"
echo "  - $EXAMPLE_DIR/x86/build/01_pipeline_basic_x86 (x86)"
echo "  - $EXAMPLE_DIR/rv1126b/build/01_pipeline_basic_rv1126b (RV1126B)"
echo "  - $EXAMPLE_DIR/rk3576/build/01_pipeline_basic_rk3576 (RK3576)"
echo "  - $EXAMPLE_DIR/rk3588/build/01_pipeline_basic_rk3588 (RK3588)"
echo ""
