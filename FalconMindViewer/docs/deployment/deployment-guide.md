...
```bash
git clone https://github.com/your-org/FalconMindViewer.git
cd FalconMindViewer
```
...
# 克隆代码
cd /opt/falconmind
git clone https://github.com/your-org/FalconMindViewer.git backend
cd backend/backend
...
```ini
[Unit]
Description=FalconMindViewer Backend
